...
# #final output
# hls_config['LayerName']['q_dense_4']['Precision']['weight'] = 'ap_fixed<7,1>'
# hls_config['LayerName']['q_dense_4']['Precision']['bias'] = 'ap_fixed<7,1>'
# hls_config['LayerName']['q_dense_4']['ReuseFactor'] = 128
