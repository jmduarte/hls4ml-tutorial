...
# Set board name
set board_name "artya737t"

# Create project
create_project $proj $proj_dir -part xc7a35ticsg324-1L

# Set project properties
set_property board_part digilentinc.com:arty-a7-37:part0:1.0 [current_project]

# Set IP repository paths
set_property ip_repo_paths ../../hls/$board_name\_m_axi_8_serial_prj/anomaly_detector_prj [current_project]
